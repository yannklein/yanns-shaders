        ...
        <Routes>
          <Route path="/" element={
            <div className="w-full min-h-screen flex flex-col items-center justify-center p-8">
              <h1 className="text-5xl leading-tight mb-8 text-gray-800">Yann's Shader Showcase</h1>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
                <Link to="/wave" className="bg-white rounded-xl p-8 no-underline text-inherit transition-all duration-200 shadow-md hover:-translate-y-1 hover:shadow-lg">
                  <h2 className="m-0 mb-4 text-gray-800">Wave Shader</h2>
                  <p className="m-0 text-gray-600">A simple wave animation effect</p>
                </Link>
                <Link to="/circle" className="bg-white rounded-xl p-8 no-underline text-inherit transition-all duration-200 shadow-md hover:-translate-y-1 hover:shadow-lg">
                  <h2 className="m-0 mb-4 text-gray-800">Circle Shader</h2>
                  <p className="m-0 text-gray-600">An animated circle pattern</p>
                </Link>
                <Link to="/noise" className="bg-white rounded-xl p-8 no-underline text-inherit transition-all duration-200 shadow-md hover:-translate-y-1 hover:shadow-lg">
